...
[**See the live project → omartaheri.com**](https://omartaheri.com)

![Omar's Digital Deck homepage](./public/website-image.jpg)
...
This repository includes a production-ready `Dockerfile`. In Coolify, use the
Dockerfile build pack, expose port `3000`, and use `/` as the health-check path.
Coolify can set `PORT` to another value if needed.
